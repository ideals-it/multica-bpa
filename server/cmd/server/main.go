...
func main() {
	...
	if err := schedulerMgr.Register(scheduler.AutopilotRuntimeRetryJob(autopilotSvc)); err != nil {
		slog.Warn("scheduler: failed to register autopilot_runtime_retry job", "error", err)
	}
	go func() {
